...
def porcentaje_uso_memoria():
    return psutil.virtual_memory().percent

def enviar_email(cont):
    email_emisor = 'pruebasarqui10@gmail.com'
    email_password = 'fqiuupmnbmarbttd'
    email_receptor = 'leninchulul@gmail.com'
...
def run():
    ...
    while True:
        ...
        porcentaje_memoria = porcentaje_uso_memoria()

        data = {'CPU': porcentaje_cpu, 'Disco': porcentaje_disco, 'Memoria': porcentaje_memoria}
        publish(client, TOPIC_ALERT, data) 
